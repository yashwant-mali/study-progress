    ...
    <>
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-slate-500">StudyFlow</p>
      ...
      <nav className="space-y-4 text-sm text-slate-300">
        <div className="rounded-3xl bg-slate-900/80 p-4 text-slate-100 shadow-inner shadow-slate-950/20">
          ...
          <ul className="mt-4 space-y-3">
            <li className="rounded-2xl bg-slate-800 px-4 py-3 text-slate-100 shadow-sm">Topics</li>
            ...
            <li className="rounded-2xl px-4 py-3 transition hover:bg-slate-800">Bookmarks</li>
          </ul>
        </div>
        ...
        <div className="rounded-3xl bg-slate-900/80 p-4 text-slate-100 shadow-inner shadow-slate-950/20">
          ...
          <ul className="mt-4 space-y-3">
            {categories.slice(0, 5).map((category) => (
              <li key={category} className="rounded-2xl px-3 py-2 transition hover:bg-slate-800">
                {category}
              </li>
            ))}
          </ul>
      ...
      <div className="mt-auto rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 p-5 text-slate-200 shadow-xl shadow-slate-950/30">
        <p className="text-xs uppercase tracking-[0.3em] text-slate-500">Study streak</p>
